...
var nextHandleId = 0;
var handlesPropName = "__lstnrs";
function EMPTY_FUNC() {}
var listeners;
function _bind(callbackFunc, thisObj) {
...
function _cleanupListeners(listeners) {
    var newListeners = [];
    var thisObj;
...
function _createRemoveListenerFunc(listeners, listener) {
    return function() {
        _removeListener(listeners, listener);
    };
}

function _createRemoveObservableFunc(handles) {
...
function checkMessage(messageName, observable) {
...
function _createMessageFunc(name) {
...
function Observable_publish(name, message) {
...
Observable.prototype = {
     ...
     */
    publish: Observable_publish,
    emit: Observable_publish
};
